...
while ($row = $result->fetch_assoc()) {
    ...
    $table .= '<tr class="border-b border-purple-700">';
...
<div class="md:container md:mx-auto">
    ...
    <select  class="text-gray-900 w-full py-2" name="department" > 
    ...
    <select  class="text-gray-900 w-full py-2" name="report_type" onchange="this.form.submit()">
        ...
        <!-- <div class="bg-teal-200 p-1">8</div> -->
...
<div class="grid grid-cols-1 sm:grid-cols-2 m-3">
        ...
        <div class="bg-blue-200 p-1 text-center font-bold text-xl align-middle sm:col-span-3"> <h1>Library Management System Report</h1></div>
       
<div class="bg-pink-200 p-1 text-center font-bold text-xl align-middle"> Export To CSV</div>
        
        <!-- Second Row -->
        <div class="bg-yellow-200 h-1/2 sm:col-span-4">
...
<div class="bg-pink-200 p-1 mt-0 sm:col-span-4">
