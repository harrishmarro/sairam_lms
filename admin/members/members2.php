 ...
 <div class="form2 w-3/4 p-4 bg-[#EEEFFF] border rounded ">
    ...
    <div class="form1">
        ...
        <form method="POST" enctype="multipart/form-data" class="grid grid-cols-2  p-4">
            ...
            <div class="span-col-1">
            <input type="submit" name="import_members" value="Import Members " class="w-1/2 border border-violet-500 bg-gradient-to-r from-blue-400 via-purple-400 to-indigo-400 p-3 rounded-r-lg">
            </div>
        </form>
    </div>
</div>
...
$sql = "SELECT member_id, member_type, name, email, phone, class, year, college_id, department, fine_amount FROM members ORDER BY member_id DESC LIMIT $offset, $recordsPerPage ";
...
<div class="" style="width:99vw;height:45vh;overflow-y:scroll;margin:20px 0px;" class="grid grid-cols-1">
    <table id="membersTable">
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="view_member.php?member_id=<?php echo $row['member_id']; ?>" class="px-2 py-1 text-green-500 hover:bg-green-300 text-gray-100 hover:text-gray-900">View</a> |
                    <a href="edit_member.php?member_id=<?php echo $row['member_id']; ?>" class="px-2 py-1 text-sky-500 hover:bg-blue-300 text-gray-100 hover:text-gray-900">Edit</a> |
                    <a class="text-red-500 hover:bg-red-300 text-gray-100 hover:text-gray-900 px-3 py-1 text-center" href="members2.php?delete_member=<?php echo $row['member_id']; ?>" onclick="return confirm('Are you sure you want to delete this member?');">Delete</a>
                </td>
            </tr>
        <?php
...
<div class="pagination" style="position: sticky; bottom: 0; background-color: #fff;">
            <?php if ($current_page > 1) : ?>
                <a href="?page=<?php echo $current_page - 1; ?>#membersTable" class="bg-[#b4a2fc]">Previous</a>
            <?php endif; ?>
    
            <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                <a href="?page=<?php echo $i; ?>#membersTable" <?php if ($i === $current_page) echo 'class="active"'; ?>class="bg-[#EEEFFF]"><?php echo $i; ?></a>
            <?php endfor; ?>
    
            <?php if ($current_page < $totalPages) : ?>
                <a href="?page=<?php echo $current_page + 1; ?>#membersTable" class="bg-[#b4a2fc]">Next</a>
            <?php endif; ?>
</div>
